...
DISKCACHE_DIRECTORY = os.environment.get('DISKCACHE_DIRECTORY', '/tmp/diskcache')
DISKCACHE_SIZE_LIMIT = eval(os.environment.get('DISKCACHE_SIZE_LIMIT', '4 * (1024 **3)'))
DISKCACHE_DEFAULT_EXPIRE = eval(os.environment.get('DISKCACHE_DEFAULT_EXPIRE', '24 * 60 * 60'))
